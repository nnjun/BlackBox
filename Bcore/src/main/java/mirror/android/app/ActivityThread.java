...
public class ActivityThread {
    ...
    public static class ProviderClientRecordP {
        public static Class<?> TYPE = RefClass.load(ProviderClientRecordP.class, "android.app.ActivityThread$ProviderClientRecord");
        @MethodReflectParams({"android.app.ActivityThread", "[Ljava.lang.String;", "android.content.IContentProvider", "android.content.ContentProvider"})
        public static RefConstructor<?> ctor;
        public static RefObject<String[]> mNames;
        public static RefObject<IInterface> mProvider;
    }
